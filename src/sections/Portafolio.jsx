        ...
        <section section id="portafolio"
            ...
            <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
                {proyectos.map((proyecto) => (
                    <div key={proyecto.nombre} className="border border-purple-900/40 bg-white/5 rounded-2xl overflow-hidden hover:border-purple-500/60 transition-colors group">
