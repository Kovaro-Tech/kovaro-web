...
function Footer() {
    return (
        <footer className="bg-black border-t border-purple-900/30 py-8 px-6">
            <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">

                {/* Logo + nombre */}
                <div className="flex items-center gap-2">
                    <img src={logo} alt="Kovaro" className="h-8 w-auto object-contain" />
                    <span className="text-white font-bold tracking-[0.3em] uppercase text-sm" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                        KOVARO
                    </span>
                </div>
